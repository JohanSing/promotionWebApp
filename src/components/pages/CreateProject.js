...
const CreateProject = () => {
  ...
  const categories = useSelector(state => state.createProjectPage.categories)
  const listProjects = useSelector(state => state.createProjectPage.listProjects)
  const projectsOwner = useSelector(state => state.createProjectPage.projectsOwner)
  const form = useSelector(state => state.createProjectPage.createPageForm)
  const projectRegistered = useSelector(state => state.createProjectPage.IsRegistered)
